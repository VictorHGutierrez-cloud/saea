        ...
        >
          ...
          <div className="relative p-8 md:p-12 lg:p-16 text-center">
            ...
            <motion.p variants={fadeUp} className="text-lg text-white/70 max-w-2xl mx-auto mb-10">
              Com {INVESTMENT.employeesCovered.toLocaleString('pt-BR')} vidas contratadas (Mendel: 800 + SAEA Center: 50) e processos 100% manuais, cada mês sem automação custa mais do que o investimento na Factorial.
            </motion.p>
